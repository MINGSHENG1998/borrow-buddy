import HeadpatIcon from '../assets/images/bondExp/Headpat_Icon.webp';
import SmallEffect from '../assets/images/bondExp/Small_Effect.webp';
import NormalEffect from '../assets/images/bondExp/Normal_Effect.webp';
import GreatEffect from '../assets/images/bondExp/Great_Effect.webp';
import AmazingEffect from '../assets/images/bondExp/Amazing_Effect.webp';

export const bondExpData = [
...
export interface bondResourceTableType {
  key: string;
  exp: number;
  name: string;
  img: any
...
export const bondResourceTable: bondResourceTableType[] = [
  {
    key: "checkIn",
    exp: 15,
    name: "Cafe Check-In",
  ...
  },
  {
    key: "mehGift2Star",
    exp: 20,
    name: "Small 2 Star Gift",
    img: SmallEffect
  },
  {
    key: "likeGift2Star",
    exp: 40,
    name: "Normal 2 Star Gift",
    img: NormalEffect
  },
  {
    key: "favorite2Star",
    exp: 60,
    name: "Great 2 Star Gift",
    img: GreatEffect
  },
  {
    key: "loved2Star",
    exp: 80,
    name: "Amazing 2 Star Gift",
    img: AmazingEffect
  },
  {
    key: "mehGift3Star",
    exp: 60,
    name: "Small 3 Star Gift",
    img: SmallEffect
  },
  {
    key: "likeGift3Star",
    exp: 120,
    name: "Normal 3 Star Gift",
    img: NormalEffect
  },
  {
    key: "favorite3Star",
    exp: 180,
    name: "Great 3 Star Gift",
    img: GreatEffect
  },
  {
    key: "loved3Star",
    exp: 240,
    name: 'Amazing 3 Star Gift',
    img: AmazingEffect
  },
];
